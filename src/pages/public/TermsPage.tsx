  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-semibold prose-a:text-primary-600">
        ...
        <p>Businesses registering on behalf of an organization represent that they are authorized to do so.</p>
        ...
        <h2 className="text-xl mt-6 mb-3">3. User Accounts</h2>
        ...
        <h2 className="text-xl mt-6 mb-3">4. User Roles</h2>
        ...
        <h2 className="text-xl mt-6 mb-3">5. Vendor Verification</h2>
        <p>Vendor verification is designed to improve trust within the marketplace.</p>
        <p>Verification may require submission of:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <h2 className="text-xl mt-6 mb-3">6. Opportunities and Marketplace Content</h2>
        <p>Leads are responsible for ensuring that opportunities they publish are:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li>Accurate</li>
          <li>Lawful</li>
          <li>Complete</li>
        ...
        <h2 className="text-xl mt-6 mb-3">7. Vendor Responsibilities</h2>
        <p>Vendors agree to:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li>Provide truthful information.</li>
          <li>Maintain valid business credentials.</li>
          <li>Keep profiles current.</li>
          <li>Respond professionally to Leads.</li>
          <li>Comply with all contractual and legal obligations arising from their business activities.</li>
        </ul>

        <hr className="my-8" />

        <h2 className="text-xl mt-6 mb-3">8. Prohibited Activities</h2>
        <p>Users must not:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>Harvest user information without permission.</li>
          <li>Publish unlawful, defamatory, abusive, or fraudulent content.</li>
          <li>Misuse verification badges or platform branding.</li>
          <li>Attempt to manipulate search rankings or marketplace visibility.</li>
        </ul>
        <p>Violation of these Terms may result in immediate suspension or termination of access.</p>

        <hr className="my-8" />

        <h2 className="text-xl mt-6 mb-3">9. Intellectual Property</h2>
        <p>All rights, title, and interest in the Platform—including software, branding, logos, designs, content, databases, and documentation—are owned by or licensed to Abhigyan Consulting.</p>
        <p>Except as expressly permitted, users may not:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li>Copy</li>
          <li>Modify</li>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>Marketplace service charges</li>
        </ul>
        <p>Any applicable fees will be communicated before they take effect.</p>

        <hr className="my-8" />

        <h2 className="text-xl mt-6 mb-3">12. Third-Party Services</h2>
        <p>The Platform may integrate with third-party providers for services such as:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>Leads will receive suitable proposals.</li>
          <li>Information provided by users is complete or accurate.</li>
        </ul>

        <hr className="my-8" />

        <h2 className="text-xl mt-6 mb-3">14. Limitation of Liability</h2>
        <p>To the fullest extent permitted by law, Abhigyan Consulting, its directors, employees, affiliates, and partners shall not be liable for any:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <h2 className="text-xl mt-6 mb-3">15. Indemnification</h2>
        <p>You agree to indemnify and hold harmless Abhigyan Consulting and its affiliates from any claims, losses, liabilities, damages, costs, or expenses arising from:</p>
        <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <p>Users may request account closure at any time, subject to applicable legal and operational retention requirements.</p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          ...
          <li>Remove existing functionality.</li>
          <li>Perform maintenance.</li>
          <li>Suspend services temporarily.</li>
          <li>Discontinue portions of the Platform.</li>
        </ul>
        <p>We will make reasonable efforts to communicate material changes where appropriate.</p>
        ...
        <h2 className="text-xl mt-6 mb-3">19. Governing Law and Jurisdiction</h2>
        <p>These Terms shall be governed by and construed in accordance with the laws of the Republic of India.</p>
        <p>Any dispute arising out of or relating to these Terms or the use of the Platform shall be subject to the exclusive jurisdiction of the competent courts located in <strong>Noida, Uttar Pradesh, India</strong>, unless otherwise required by applicable law.</p>

        <hr className="my-8" />

        <h2 className="text-xl mt-6 mb-3">20. Severability</h2>
        ...
        <h2 className="text-xl mt-6 mb-3">22. Contact Information</h2>
