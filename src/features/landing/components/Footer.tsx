      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">BidTracker</span>
          </div>
        ...
        <div className="mt-8 border-t border-slate-100 pt-8 text-center md:flex md:items-center md:justify-between dark:border-slate-800">
          <p className="text-sm text-slate-400 dark:text-slate-500">
            &copy; {new Date().getFullYear()} BidTracker Inc. All rights reserved.
          </p>
